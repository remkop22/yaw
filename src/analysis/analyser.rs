use crate::common::{Item, ItemSet, Symbol, Grammar, Terminal};
	...
	NT: 'static + Eq + Hash + Copy + std::fmt::Debug,
{
	...
	fn close_set(&self, set: &HashSet<Item<'g, T, NT>>, already_closed: &mut HashSet<Symbol<T, NT>>) -> HashSet<Item<'g, T, NT>> {
